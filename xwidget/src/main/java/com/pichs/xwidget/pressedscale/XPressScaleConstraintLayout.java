 ...
 */
public class XPressScaleConstraintLayout extends ConstraintLayout {
    ...
    public XPressScaleConstraintLayout(Context context) {
        this(context, null);
    }

    public XPressScaleConstraintLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XPressScaleConstraintLayout(Context context, AttributeSet attrs, int defStyleAttr) {
