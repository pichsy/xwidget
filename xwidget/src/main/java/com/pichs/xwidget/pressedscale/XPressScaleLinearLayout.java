 ...
 */
public class XPressScaleLinearLayout extends LinearLayout {
    ...
    public XPressScaleLinearLayout(Context context) {
        this(context, null);
    }

    public XPressScaleLinearLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XPressScaleLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
