...
public class XNestedTopAreaBehavior extends XViewOffsetBehavior<View> {
    ...
    public XNestedTopAreaBehavior(Context context) {
        this(context, null);
    }


    public XNestedTopAreaBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public boolean onInterceptTouchEvent(@NonNull CoordinatorLayout parent,
        ...
        switch (ev.getActionMasked()) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (yDiff > touchSlop) {
                    isBeingDragged = true;
                    if(child instanceof WebView || child instanceof XNestedTopDelegateLayout){
    ...
    void scroll(@NonNull CoordinatorLayout parent, @NonNull View child, int dy) {
        ...
        if (child instanceof XNestedTopView) {
            unConsumed = ((XNestedTopView) child).consumeScroll(unConsumed);
        }
    ...
    public void onNestedPreScroll(@NonNull CoordinatorLayout parent, @NonNull View child,
        ...
        if (target == child) {
            ...
            if (dy > 0) {
                ...
                if (target instanceof XNestedBottomView) {
                    int contentHeight = ((XNestedBottomView) target).getContentHeight();
                    int minOffset;
        ...
        if (target == child) {
            ...
            if (dyUnconsumed > 0) {
                ...
                if (bottomView == null || bottomView.getVisibility() == View.GONE) {
                    ...
                    int contentHeight = ((XNestedBottomView) bottomView).getContentHeight();
                    ...
                    if (canContentScroll) {
                        ((XNestedBottomView) bottomView).consumeScroll(dyUnconsumed);
                    }
                }
            }
        } else {
            ...
            if (dyUnconsumed < 0) {
                ...
                if (child instanceof XNestedTopView) {
                    ((XNestedTopView) child).consumeScroll(dyUnconsumed);
                }
            }
        }
    }
    ...
    private View findBottomView(CoordinatorLayout parent) {
        for (int i = 0; i < parent.getChildCount(); i++) {
            ...
            if (child instanceof XNestedBottomView) {
                return child;
            }
        }
        return null;
    ...
    class ViewFlinger implements Runnable {
        ...
        ViewFlinger(Context context) {
            mOverScroller = new OverScroller(context, XInterpolators.quintic);
        }
        ...
        public void run() {
            ...
            if (scroller.computeScrollOffset()) {
                ...
                if (mCurrentParent != null && mCurrentChild != null) {
                    ...
                    if(mCurrentParent instanceof XNestedScrollLayout){
                        XNestedScrollLayout layout = (XNestedScrollLayout) mCurrentParent;
        ...
        private void onFlingOrScrollStart(CoordinatorLayout parent, View child) {
            ...
            if (mInterpolator != XInterpolators.quintic) {
                ...
                mOverScroller = new OverScroller(mCurrentParent.getContext(), XInterpolators.quintic);
            }
        }
