...
public class PickerColorView extends View {
    ...
    public PickerColorView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PickerColorView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
     ...
     * 如果想设置 alpha ，可以在{@link OnColorPickerChangeListener#onColorChanged(PickerColorView, int)} 回调
     *
     * @param colors 颜色值
     */
    ...
    public interface OnColorPickerChangeListener {
         ...
         * @param color  颜色
         */
        void onColorChanged(PickerColorView picker, int color);
