...
public class XRadioCardLinearLayout extends XCardLinearLayout implements XRadioButtonCheckable {

    private final XRadioItemHelper mRadioItemHelper;

    public XRadioCardLinearLayout(Context context) {
        this(context, null);
    }

    public XRadioCardLinearLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XRadioCardLinearLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
