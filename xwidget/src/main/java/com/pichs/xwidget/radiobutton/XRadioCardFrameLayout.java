...
public class XRadioCardFrameLayout extends XCardFrameLayout implements XRadioButtonCheckable {

    private final XRadioItemHelper mRadioItemHelper;

    public XRadioCardFrameLayout(Context context) {
        this(context, null);
    }

    public XRadioCardFrameLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XRadioCardFrameLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
