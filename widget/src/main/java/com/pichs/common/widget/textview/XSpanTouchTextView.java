 ...
 * TextView 会在 {@link #onTouchEvent(MotionEvent)} 时将事件传递给 {@link XLinkTouchMovementMethod},
 ...
 */
public class XSpanTouchTextView extends XTextView implements XISpanTouch, XILayout {
    /**
    ...
    public XSpanTouchTextView(Context context) {
        this(context, null);
    }

    public XSpanTouchTextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XSpanTouchTextView(Context context, AttributeSet attrs, int defStyleAttr) {
