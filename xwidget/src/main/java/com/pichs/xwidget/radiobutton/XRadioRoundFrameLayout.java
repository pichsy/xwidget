...
public class XRadioRoundFrameLayout extends XRoundFrameLayout implements XRadioButtonCheckable {

    private final XRadioItemHelper mRadioItemHelper;

    public XRadioRoundFrameLayout(Context context) {
        this(context, null);
    }

    public XRadioRoundFrameLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XRadioRoundFrameLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
