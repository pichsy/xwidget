...
public class XCardButton extends XButton implements XILayout {
    ...
    public XCardButton(Context context) {
        this(context, null);
    }

    public XCardButton(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XCardButton(Context context, AttributeSet attrs, int defStyleAttr) {
