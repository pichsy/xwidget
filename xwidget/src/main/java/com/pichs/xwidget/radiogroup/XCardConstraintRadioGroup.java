...
public class XCardConstraintRadioGroup extends XCardConstraintLayout implements XRadioGroup {
    ...
    public XCardConstraintRadioGroup(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XCardConstraintRadioGroup(Context context, AttributeSet attrs, int defStyleAttr) {
