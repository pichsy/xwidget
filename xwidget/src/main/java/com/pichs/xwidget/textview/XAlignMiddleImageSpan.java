 ...
 * 支持垂直居中的ImageSpan
 */
public class XAlignMiddleImageSpan extends ImageSpan  {
     ...
     */
    public XAlignMiddleImageSpan(Drawable d, int verticalAlignment) {
     ...
     */
    public XAlignMiddleImageSpan(@NonNull Drawable d, int verticalAlignment, float fontWidthMultiple) {
