 ...
 * XCardTextView
 */
public class XCardEditText extends XEditText implements XILayout {
    private XLayoutHelper mLayoutHelper;

    public XCardEditText(Context context) {
        this(context, null);
    }

    public XCardEditText(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.editTextStyle);
    }

    public XCardEditText(Context context, AttributeSet attrs, int defStyleAttr) {
