...
public class XOvalImageView extends AppCompatImageView implements XIAlpha {
    ...
    public XOvalImageView(Context context) {
        this(context, null);
    }

    public XOvalImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XOvalImageView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.XOvalImageView, defStyle, 0);
        int index = a.getInt(R.styleable.XOvalImageView_android_scaleType, -1);
        if (index >= 0) {
        ...
        mBorderWidth = a.getDimensionPixelSize(R.styleable.XOvalImageView_xp_borderWidth, -1);
        if (mBorderWidth < 0) {
            mBorderWidth = DEFAULT_BORDER_WIDTH;
        }

        mBorderColor = a.getColorStateList(R.styleable.XOvalImageView_xp_borderColor);
...
//        super.setBackgroundDrawable(mBackgroundDrawable);
     ...
     * width.
     *
     * @return if this {@link XOvalImageView} is set to oval.
     */
