...
public class XNestedTopDelegateLayout extends FrameLayout implements NestedScrollingChild2, NestedScrollingParent2, XNestedTopView {

    public static final String KEY_SCROLL_INFO_OFFSET = "@xwidget_scroll_info_top_dl_offset";

    private OnScrollNotifier mScrollNotifier;
    private View mHeaderView;
    private XNestedTopView mDelegateView;
    private View mFooterView;
    private XViewOffsetHelper mHeaderViewOffsetHelper;
    private XViewOffsetHelper mDelegateViewOffsetHelper;
    private XViewOffsetHelper mFooterViewOffsetHelper;
    ...
    public XNestedTopDelegateLayout(@NonNull Context context) {
        this(context, null);
    }

    public XNestedTopDelegateLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
    ...
    public void setHeaderView(@NonNull View headerView) {
        ...
        mHeaderViewOffsetHelper = new XViewOffsetHelper(headerView);
        addView(headerView, new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));
    }

    public void setDelegateView(@NonNull XNestedTopView delegateView) {
        ...
        mDelegateViewOffsetHelper = new XViewOffsetHelper(view);
    ...
    public void setFooterView(@NonNull View footerView) {
        ...
        mFooterViewOffsetHelper = new XViewOffsetHelper(footerView);
    ...
    public XNestedTopView getDelegateView() {
    ...
    public void restoreScrollInfo(@NonNull Bundle bundle) {
        ...
        offsetTo(XLangHelper.constrain(-offset, 0, getContainerOffsetRange()));
        if (mDelegateView != null) {
