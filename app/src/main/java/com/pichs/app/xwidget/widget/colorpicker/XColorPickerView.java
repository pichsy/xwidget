package com.pichs.app.xwidget.widget.colorpicker;
...
public class XColorPickerView extends LinearLayout {
    ...
    private int index = 0;
    private XColorPreviewView cpvColorPreview;
    ...
    public XColorPickerView(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//        this.blue = blue;
//        transValue = alpha;
//        transBarLayoutParams.leftMargin = (int) ((alpha / 255F) * rlTransBar.getWidth() - vTransBar.getWidth() / 2F);
//        vTransBar.setLayoutParams(transBarLayoutParams);
//        vBgColor.setBackgroundColor(Color.rgb(red, green, blue));
//        cpvColorPreview.setColor(Color.argb(transValue, red, green, blue));
//        int progress = getProgressColor(red, green, blue);
//        colorBarLayoutParams.leftMargin = (int) (progress * llColorProgress.getWidth() - vColorBar.getWidth() / 2F);
//
//        vLocationLayoutParams.leftMargin = (int) (vBgColor.getWidth() - vLocation.getWidth() - (1 - (float) red / 255) * vBgColor.getWidth());
//        vLocationLayoutParams.topMargin = (int) ((float) green / 255 * vBgColor.getHeight());
//        vLocation.setLayoutParams(vLocationLayoutParams);
//    }
//
//    private int getProgressColor(int red, int green, int blue) {
//        float vRed = (red == 255) ? 1 : (float) (red / 255.0);
//        float vGreen = (float) (green == 255 ? 1 - green / 255.0 : green / 255.0);
//        float vBlue = (float) ((blue == 255) ? (blue / 255.0) : (1 - (blue / 255.0)));
//        float progressRed = vRed * (red == 255 ? 255 : (255 - red));
//        float progressGreen = vGreen * (green == 255 ? 0 : green);
//        float progressBlue = vBlue * (blue == 255 ? blue : (600 - blue));
//        return (int) (progressRed + progressGreen + progressBlue);
//    }
