...
package com.pichs.common.widget.flowlayout;
...
import com.pichs.common.widget.view.XViewGroup;
 ...
 * </ul>
 * <p>在 xml 中采用 {@link R.styleable#XFlowLayout} 控制以上属性。</p>
 */
public class XFlowLayout extends XViewGroup {
    ...
    private void init(Context context, AttributeSet attrs) {
        TypedArray array = context.obtainStyledAttributes(attrs,
                R.styleable.XFlowLayout);
        mChildHorizontalSpacing = array.getDimensionPixelSize(
                R.styleable.XFlowLayout_xp_childHorizontalSpacing, 0);
        mChildVerticalSpacing = array.getDimensionPixelSize(
                R.styleable.XFlowLayout_xp_childVerticalSpacing, 0);
        mGravity = array.getInteger(R.styleable.XFlowLayout_android_gravity, Gravity.LEFT);
        int maxLines = array.getInt(R.styleable.XFlowLayout_android_maxLines, -1);
        if (maxLines >= 0) {
            setMaxLines(maxLines);
        }
        int maxNumber = array.getInt(R.styleable.XFlowLayout_xp_maxNumber, -1);
        if (maxNumber >= 0) {
